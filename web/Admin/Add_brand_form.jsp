...
<!------ Include the above in your HEAD tag ---------->
	 ...
	 <div class="pull-right" style="padding-top: 100px;padding-right: 125px">
             <a href="view_brands.jsp"><button style="height: 35px;" class="btn btn-default btn-xs btn-filter"><i class="fa fa-tasks"></i>&nbsp;View Brands</button></a>&nbsp;&nbsp;
                </div>
            ...
            <div class="form" style="background-color: white">
                ...
                <div style="background-color: black;height: 40px">
                    <h2> <center><lable style="color: white;">Add Brand</lable></center></h2>
                ...
                <div class="form-content" style="padding-top: 10px">
                    ...
                    <center><form method="post" action="Add_brand.jsp">
                            
                            <div class="form-group">
                                <h3>Brand name</h3>
                                <input type="text" class="form-control" style="width: 50%" name="brand_name" placeholder="Brand name" value="" required=""/>
                            </div>
                            <div class="form-group">
                                <h3>Status</h3>
