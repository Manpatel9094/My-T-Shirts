	...
	<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto">
		      ...
		      <li class="nav-item">
                          <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="view_cart.jsp">My cart &nbsp;<i style='font-size:17px' class="fas fa-shopping-cart"></i></a>
		      </li>
                      <li class="nav-item">
                          <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Profile.jsp"><% String email=(String) session.getAttribute("user"); out.print(email);%> &nbsp;<i style='font-size:17px' class="fas fa-user"></i></a>
		      </li>
            ...
            <div class="card-body text-center">
                <div class="ad-title m-auto">
                    <h5><% out.println(rs.getString("prod_name"));%></h5>
                                    ...
                                    <% out.println("<a class="+"ad-btn"+" style="+"background-color: skyblue"+" href="+"View_single_product.jsp?product_id="+rs.getString("product_id")+" >View</a>"); %>
 ...
 <footer class="footer text-center">
    <div class="container">
      <div class="row">
		...
		<p>
                <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#shop">Shop</a>
                <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#cart">Cart</a></p>
