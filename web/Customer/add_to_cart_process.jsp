...
int i=st.executeUpdate("insert into tbl_cart(email_id,product_id)values('"+email_id+"','"+product_id+"')");
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Add to Cart')");
                out.println("location='view_cart.jsp'");
                out.println("</script>");
